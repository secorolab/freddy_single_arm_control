...
#define NODE_MAIN_LOGGER_NAME "motion_specification_action_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<motion_specification_action::MotionSpecificationActionClient>";
