...
namespace motion_specification_action
{
  ...
  private:
    ...
    double DAMPING_GAIN_JOINT_IMPEDANCE_CTRL_PRE_JNT_CONFIG;
    double SIGMOID_SLOPE_K_IMPEDANCE_CTRL_PRE_JNT_CONFIG;
    double PRE_JNT_CONFIG_IMPEDANCE_CTRL_VEL_THRESHOLD;
    ...
    void read_ms_conditions_count(
      ...
      int &per_condition_constraint_count,
      int &post_condition_constraint_count);
    void read_frame_and_action_names(const YAML::Node &motion_specification_params_object);
